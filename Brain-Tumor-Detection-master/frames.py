...
class Frames:
    ...
    def __init__(self, mainObj, MainWin, wWidth, wHeight, function, Object, xAxis=10, yAxis=10):
        ...
        self.btnClose = tkinter.Button(self.winFrame, text="Close",width=8,font=("Arial",15,"bold"),
                                      command=lambda: self.quitProgram(self.MainWindow))
        self.btnClose.place(x=450, y=800)
        self.btnView = tkinter.Button(self.winFrame, text="View",width=8,font=("Arial",15,"bold"),command=lambda: self.NextWindow(self.method))
        self.btnView.place(x=200, y=800)
